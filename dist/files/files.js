...
class FileManager {
     ...
     */
    async uploadFile(filePath, uploadOptions, chunkSize = 1024 * 1024) {
        ...
        for (let chunkNumber = 1; chunkNumber <= totalChunks; chunkNumber++) {
            ...
            if (uploadOptions.iv)
                formData.append('iv', uploadOptions.iv);
            if (uploadOptions.media_width)
                formData.append('media_width', String(uploadOptions.media_width));
            if (uploadOptions.media_height)
                formData.append('media_height', String(uploadOptions.media_height));
            // Auth
