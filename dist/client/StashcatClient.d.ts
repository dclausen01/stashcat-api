...
import { Broadcast, BroadcastContentOptions, SendBroadcastOptions, BroadcastMemberListOptions } from '../broadcast/types';
...
export declare class StashcatClient {
    ...
    listBroadcastMembers(listId: string, options?: BroadcastMemberListOptions): Promise<unknown[]>;
